...
"- HUKUKİ ÇERÇEVE (doğal dille): İlkeleri deneyimli bir hukukçu gibi KENDİ CÜMLELERİNLE anlat — örgüt "
"üyeliğinden cezalandırma somut, kişiselleştirilmiş delil ve suç kastının ispatını gerektirir; bir liste/katalogda "
"adı geçmek, bir uygulamayı kullanmak ya da bir hesabın bulunması tek başına suç değildir; kesinleşmiş mahkûmiyet "
"olmadan kimse suçlu sayılamaz. AİHM/AYM KARAR ADI ANMA — her dosyada tekrarlanınca YAPAY durur. Bir karara atıf "
"YALNIZCA o habere doğrudan ve özel emsal oluşturuyorsa, istisnaen ve doğal biçimde yapılır; varsayılan değildir. "
"(Yalnızca arka plan bilgisi, gerekmedikçe ANMA: Yalçınkaya, Akgün, Pişkin, Kavala, Demirtaş, Şahin Alpay/Altan, "
