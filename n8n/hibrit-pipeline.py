...
"piknik/çay-bahçesi buluşması, sohbet toplantısı, bağış/himmet/burs, gazete-dergi aboneliği, bir uygulamayı "
"(ByLock vb.) indirmek, bankada (Bank Asya) hesap açmak, dernek/sendika/vakıf üyeliği, belirli okul/dershaneye "
"gitmek; VE ÖZELLİKLE bir KİTABI ya da KUR'AN TEFSİRİNİ / dini eseri okumak-bulundurmak — sırf yazarı "
"yargılanan/itham edilen biri diye. Bu tür bir fiili suç/delil gibi sunan haberi işaretle ve gerekçede ŞUNU "
"vurgula: suçta kanunilik ve öngörülebilirlik ilkesi (AİHS m.7, Anayasa m.38) gereği, herkese açık ve yasal "
"bir fiil, onu yapanın kimliğine bakılarak sonradan suça dönüştürülemez; yasal yayımlanmış bir eseri okumak/"
"bulundurmak ifade ve bilgiye erişim (AİHS m.10) ile din özgürlüğü (m.9) kapsamındadır; örgüt üyeliği "
"kişiselleştirilmiş kast ve somut delil ister, tek başına böyle bir fiil yetmez (krş. Yalçınkaya 2023). "
